...
All 612 planned outcomes were collected: 601 procedures completed and eleven publication trials failed (Table~\ref{tab:followup-outcomes}). Four failures occurred during warm-up and seven during measurement. Ten concerned always profiles; one occurred in historical JetStream's periodic profile. The seven timed failures retain 14651 confirmed and 22 unknown request records, without a successful-workload rate imputed for their incomplete runs. Warm-up failures have no timed trace. The supplement lists every failure and distinguishes client confirmations from later, non-atomic broker inventories.
