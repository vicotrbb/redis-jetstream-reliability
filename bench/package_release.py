...
def main():
    ...
    core += ['paper/appendix-proofs.tex','paper/appendix-history.tex',
             'paper/appendix-client-waits.tex','paper/appendix-followup.tex','paper/followup-results.tex',
             ...
             'docs/FOLLOWUP_PROTOCOL.md','docs/FOLLOWUP_VALIDATION.md','docs/FINAL_REVISION_VALIDATION.md',
             'data/derived/operational-report.json','revisions/20260925-integrated/baseline.json',
             'revisions/20260925-integrated/integration-check.json',
             'revisions/20260925-integrated/manuscript-number-check.json',
             'revisions/20260925-integrated/document-provenance-check.json']
    ...
    with tempfile.TemporaryDirectory(prefix=f'.v{version}-',dir=destination.parent) as staging_name:
        ...
        with tempfile.TemporaryDirectory(prefix='msgrel-release-verification-') as extracted_name:
            ...
            for script in ('check_paper.py','check_revision.py','check_followup.py','report_operational.py',
                           'check_manuscript_numbers.py','check_integrated_paper.py','check_document_provenance.py'):
